...
%Lexicon = (
      ...
      'You have added a subscription for [_1].' => 'Hai aggiunto un abbonamento per [_1].',
      'You have successfully deleted the selected subscriptions.' => 'Hai cancellato con successo gli abbonamenti selezzionati.',
      'Quickfilters' => 'Filtri veloci',
      'Useful links' => 'Collegamenti utili',
      'Download Subscriptions (CSV)' => 'Scarica abbonamenti (CSV)',
      ...
      'Click to show only blocked subscriptions' => 'Clicca per mostrare solo gli abbonamenti bloccati',
      'Blocked' => 'Bloccato',
      'Click to show only active subscriptions' => 'Clicca per mostrare solo gli abbonamenti attivi',
      'Active' => 'Attivo',
      'Click to show only pending subscriptions' => 'Clica per mostrare solo gli abbonamenti in attesa',
      'Pending' => 'In attesa',
